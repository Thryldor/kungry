...
import ca.ulaval.ima.mp.ui.review.list.dummy.DummyContent
import ca.ulaval.ima.mp.ui.review.list.dummy.DummyContent.DummyItem

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [ReviewFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = ReviewRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
